...
<div class="summary">
    ...
    <div class="summary-grid">
        <div class="summary-item">
            ...
            <div class="summary-label">Total officer/staff</div>
        </div>
        <div class="summary-item">
        ...
        <div class="summary-item">
            <div class="summary-value">{{ abs(number_format($total_training_hours, 1)) }}</div>
            <div class="summary-label">Total Training Hours</div>
        </div>
        <div class="summary-item">
            <div class="summary-value">
                @php
                    $avgHours = $total_employees > 0 ? abs($total_training_hours) / $total_employees : 0;
                @endphp
                {{ abs(number_format($avgHours, 1)) }}
            </div>
...
<div class="footer">
    This report was generated by Officer/staff Training Management System.<br>
    Report ID: TR-{{ date('YmdHis') }}
</div>
</body>
</html>
